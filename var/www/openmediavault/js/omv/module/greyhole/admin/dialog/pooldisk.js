	...
	getFormItems:function ()
	{
		return [
			...
			},
			{
				...
				infoText  :_("This is how much free space you want to reserve on each drive. This is a soft limit that will be ignored if the necessary hard drives are below their minimum.")
			}
		];
	},
